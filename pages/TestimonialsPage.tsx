    ...
    <div ref={containerRef} className="min-h-screen bg-slate-50 pt-24 pb-32 md:pt-40">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center mb-24">
          <h1 className="page-title text-6xl md:text-8xl font-black text-slate-900 mb-8 tracking-tighter">
            Real Impact.
          </h1>
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
          {TESTIMONIALS.map((testimonial, idx) => (
            <div 
              key={testimonial.id} 
              className={`testimonial-item break-inside-avoid p-8 rounded-[2rem] transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ${
                  idx % 3 === 0 ? 'bg-slate-900 text-white' : 'bg-white border border-slate-100 shadow-sm'
              }`}
            >
