    ...
    <div ref={containerRef} className="min-h-screen bg-slate-50 pt-24 pb-10 md:pt-32 md:pb-20 px-4 md:px-6">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-8 md:mb-12">
          <div className="category-label flex items-center gap-2 text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-tight mb-3 md:mb-4 font-body">
          ...
          <div className="flex gap-2 md:gap-3 overflow-x-auto pb-8 pt-4 -mb-4 -mt-4 scrollbar-hide -mx-4 px-4 md:mx-0 md:px-2 md:flex-wrap items-start">
            {categories.map((cat) => (
              <button
                ...
                className={`category-pill flex-shrink-0 whitespace-nowrap px-4 py-2 md:px-6 md:py-2.5 rounded-full text-xs md:text-sm font-subheading font-bold transition-all duration-300 border select-none ${selectedCategory === cat
