    ...
    <div ref={containerRef} className="min-h-screen bg-slate-50 pt-24 pb-32 md:pt-40 md:pb-24 px-4 md:px-6">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-10">
            <div className="catalog-header opacity-0"> {/* Initial opacity 0 to prevent flash before animation */}
            ...
            {/* Search Bar */}
            <div className="catalog-search w-full lg:w-96 relative group opacity-0">
        ...
        <div className="mb-12">
            <div className="category-label flex items-center gap-2 text-sm font-bold text-slate-400 uppercase tracking-widest mb-4 opacity-0">
                <Filter size={14} />
            ...
            <div className="flex gap-3 overflow-x-auto pb-4 md:pb-0 scrollbar-hide -mx-4 px-4 md:mx-0 md:px-0 md:flex-wrap min-h-[50px] items-start">
              {categories.map((cat) => (
                <button
                  ...
                  className={`category-pill opacity-0 flex-shrink-0 whitespace-nowrap px-6 py-2.5 rounded-full text-sm font-bold transition-all duration-300 border select-none ${
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-8">
          {filteredProducts.length > 0 ? (
            ...
            <div className="col-span-full py-32 text-center bg-white rounded-3xl border border-dashed border-slate-200 product-item opacity-0">
