            ...
            <div className="container mx-auto px-4 md:px-6">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                        ...
                        <div className="lg:w-1/2">
                            ...
                            <div className="mt-12 grid grid-cols-3 gap-6 text-center border-t border-slate-200 pt-10">
                                ...
                                <div>
                                    <h3 className="text-3xl md:text-4xl font-black font-heading text-slate-900">24/7</h3>
                ...
                <section id="contact" className="bg-white rounded-[3rem] p-8 md:p-16 lg:p-20 shadow-sm border border-slate-100">
                    <div className="text-center mb-16">
                        <span className="text-yellow-500 font-bold tracking-widest uppercase text-sm mb-4 block">Get In Touch</span>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-20">
                        ...
                        <div className="lg:col-span-2 space-y-12">
                            <div className="space-y-8">
                                <div className="flex items-start gap-6 group">
                                    <div className="bg-slate-50 p-4 rounded-2xl shadow-sm text-slate-900 group-hover:bg-yellow-400 group-hover:text-slate-900 transition-colors">
                                        <Phone size={28} strokeWidth={2.5} />
                                    </div>
                                    <div>
                                        <p className="font-bold text-slate-400 text-sm uppercase tracking-wider mb-2">Phone / WhatsApp</p>
                                        <a href={`https://wa.me/${WHATSAPP_NUMBER}`} className="font-bold text-slate-900 text-xl hover:text-yellow-500 transition-colors">
                                            +91 90004 21844
                                        </a>
                                        <p className="text-sm text-slate-500 font-medium mt-1">Available Mon-Sat, 9am - 8pm</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-6 group">
                                    ...
                                    <div>
                                        <p className="font-bold text-slate-400 text-sm uppercase tracking-wider mb-2">Email Address</p>
                                        <a href="mailto:support@jfsfitness.com" className="font-bold text-slate-900 text-xl hover:text-yellow-500 transition-colors">
                                            support@jfsfitness.com
                                        </a>
                                        <p className="text-sm text-slate-500 font-medium mt-1">We reply within 24 hours</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-6 group">
                                    ...
                                    <div>
                                        <p className="font-bold text-slate-400 text-sm uppercase tracking-wider mb-2">Headquarters</p>
                                        <p className="font-bold text-slate-900 text-lg leading-snug">
                                            123 Muscle Ave, Fit City,<br />
                                            State, India 400001
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="pt-8 border-t border-slate-100">
                                ...
                                <div className="flex gap-4">
                                    <a href="#" className="bg-slate-50 hover:bg-slate-900 hover:text-white p-4 rounded-2xl text-slate-600 transition-all duration-300">
                                        <Instagram size={24} />
                                    </a>
                                    <a href="#" className="bg-slate-50 hover:bg-slate-900 hover:text-white p-4 rounded-2xl text-slate-600 transition-all duration-300">
                                        <Facebook size={24} />
                        ...
                        {/* Contact Form */}
                        <div className="lg:col-span-3 bg-slate-50 p-8 md:p-12 rounded-[2.5rem] border border-slate-200">
                            <h3 className="font-black font-heading text-3xl text-slate-900 uppercase tracking-tight mb-8">Send a Message</h3>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            id="name"
                                            className="w-full bg-white border border-slate-200 rounded-xl px-5 py-4 text-slate-900 focus:outline-none focus:border-slate-900 focus:ring-1 focus:ring-slate-900 transition-all font-medium placeholder:text-slate-400"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        id="message"
                                        rows={6}
                                        className="w-full bg-white border border-slate-200 rounded-xl px-5 py-4 text-slate-900 focus:outline-none focus:border-slate-900 focus:ring-1 focus:ring-slate-900 transition-all font-medium resize-none placeholder:text-slate-400"
