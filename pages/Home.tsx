...
const Home: React.FC<HomeProps> = ({ onAddToCart }) => {
  ...
  return (
    <div ref={containerRef} className="flex flex-col w-full overflow-hidden bg-white">
      ...
      <section className="relative min-h-[90vh] bg-slate-950 flex items-center justify-center overflow-hidden">
         {/* Background Elements */}
         ...
         <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-12 pt-20">
            <div className="hero-content flex-1 text-center md:text-left">
                <div className="inline-block px-4 py-1.5 rounded-full border border-yellow-500/30 bg-yellow-500/10 text-yellow-400 font-bold text-xs uppercase tracking-widest mb-6 backdrop-blur-sm">
                ...
                <p className="text-slate-400 text-lg md:text-xl max-w-xl leading-relaxed mb-8 mx-auto md:mx-0">
                    Authentic supplements sourced directly from brands. No middlemen, no fake products. Just pure performance.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    <Button onClick={() => navigate('/products')} className="bg-yellow-400 text-slate-900 hover:bg-yellow-300 border-none px-10 py-4 text-lg font-black uppercase tracking-wider">
                        Shop Now
                    </Button>
                    <Button variant="outline" className="text-white border-slate-700 hover:bg-slate-800 hover:text-white px-10 py-4 text-lg font-bold">
                        View Brands
                    </Button>
                </div>
            </div>
      ...
      <section className="categories-section py-16 bg-white">
          <div className="container mx-auto px-6">
              <h2 className="text-3xl font-black text-slate-900 text-center mb-12 uppercase tracking-tighter">Shop By Category</h2>
      ...
      <section className="bestsellers-section py-12 bg-slate-50">
          <div className="container mx-auto px-6">
             <div className="flex justify-between items-end mb-10">
                 <div>
                     <h2 className="text-3xl font-black text-slate-900 tracking-tighter mb-2">Best Sellers</h2>
      ...
      <section className="authenticity-section py-24 bg-slate-900 relative overflow-hidden my-8">
          ...
          <div className="container mx-auto px-6">
             <div className="flex justify-between items-end mb-10">
                 <div>
                     ...
                     <h2 className="text-3xl font-black text-slate-900 tracking-tighter mt-1">New Arrivals</h2>
                 </div>
      ...
      {/* 7. Trending in Whey (FIXED) */}
       <section className="trending-section py-20 bg-slate-50 relative">
          <div className="container mx-auto px-6 relative z-10">
      ...
      <section className="py-20 bg-white">
          <div className="container mx-auto px-6">
             <div className="text-center mb-16">
                 <h2 className="text-3xl font-black text-slate-900">Why Choose Supplemart?</h2>
             </div>
